...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.ymt.grpc.common.Hello.HelloRequest,
      com.ymt.grpc.common.Hello.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = com.ymt.grpc.common.Hello.HelloRequest.class,
      responseType = com.ymt.grpc.common.Hello.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.ymt.grpc.common.Hello.HelloRequest,
      com.ymt.grpc.common.Hello.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.ymt.grpc.common.Hello.HelloRequest, com.ymt.grpc.common.Hello.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.ymt.grpc.common.Hello.HelloRequest, com.ymt.grpc.common.Hello.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ymt.grpc.common.Hello.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ymt.grpc.common.Hello.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.ymt.grpc.common.Hello.HelloRequest request,
        io.grpc.stub.StreamObserver<com.ymt.grpc.common.Hello.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.ymt.grpc.common.Hello.HelloRequest,
                com.ymt.grpc.common.Hello.HelloResponse>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.ymt.grpc.common.Hello.HelloResponse sayHello(com.ymt.grpc.common.Hello.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.ymt.grpc.common.Hello.HelloResponse> sayHello(
        com.ymt.grpc.common.Hello.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.ymt.grpc.common.Hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.ymt.grpc.common.Hello.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.ymt.grpc.common.Hello.getDescriptor();
    }
